  ...
  heap: {
    buttons: [
      ...
      },
      {
        title: "getLevelOrder",
        description:
          "Mostrar el recorrido level-order del Heap como arreglo (y animación).",
        estructura: "nombreObjeto.getLevelOrder();",
        ejemplo: "arbolHeap.getLevelOrder();",
      },
      {
        title: "clean",
        description: "Borrar el Heap",
        estructura: "nombreObjeto.clean();",
        ejemplo: "arbolHeap.clean();",
      },
    ],
  },
    ...
    buttons: [
      {
        ...
        estructura: `Si el objeto no ha sido instanciado: <strong>insert(valor);</strong> 
               Si el objeto ya existe: <strong>nombreObjeto.insert(valor);</strong>`,
        ejemplo:
          "<strong>insert(1);</strong> ó <strong>arbolHeap.insert(1);</strong>",
      },
      {
        title: "delete",
