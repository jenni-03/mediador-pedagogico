...
import {
  ...
  animateClearSequence,
} from "../../../../../shared/utils/draw/sequenceDrawActions";
...
export function useSequenceRender(
  ...
  useEffect(() => {
    ...
    const margin = {
      left: SVG_SEQUENCE_VALUES.MARGIN_LEFT,
      right: SVG_SEQUENCE_VALUES.MARGIN_RIGHT,
    };
    ...
    const width =
      margin.left +
      displayLength * (elementWidth + spacing) -
      spacing +
      SVG_SEQUENCE_VALUES.EXTRA_WIDTH;
