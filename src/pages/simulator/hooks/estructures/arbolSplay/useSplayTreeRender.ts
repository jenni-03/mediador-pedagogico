...
import { animateSplayInsertNode, animateSplaySearch } from "../../../../../shared/utils/draw/SplayTreeDrawActions";
...
export function useSplayTreeRender(
    ...
    console.log("Frames");
    console.log(splayFramesLayouts);
    console.log("Traza splay");
    console.log(query.splayTrace);
    console.log("Rotaciones");
    console.log(query.splayTrace?.rotations);
