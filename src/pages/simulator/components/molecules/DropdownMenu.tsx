  ...
  return (
    <div
      ...
      className="
        ...
        bg-[#1f1f1f] border-t border-[#2a2a2a] shadow-xl
        py-6 px-4 sm:px-10
      "
    >
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-white font-bold text-lg">
          {type === "sim" ? "Simuladores disponibles" : "Conceptos disponibles"}
        </h2>
        <button
          onClick={onClose}
      ...
      {/* Aquí envolvemos el grid para darle un alto máximo y scroll interno */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
          {items.map((item) => (
            <Link
              ...
              onClick={onClose}
              className="
                block px-4 py-2 bg-[#262626] rounded
