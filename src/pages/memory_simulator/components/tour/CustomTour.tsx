...
import {
  getTourDescriptions,
  TourStep,
} from "../../../../shared/constants/tourDescriptions";
import TourOverlay from "./TourOverlay";
import HighlightBox from "./HighlightBox";
import TourTooltip from "./TourTooltip";
import ArrowPointer from "./ArrowPointer";

type TourType = "memoria" | "estructuras";
...
const CustomTour: React.FC<CustomTourProps> = ({ tipo }) => {
  const tourSteps: TourStep[] = getTourDescriptions(tipo);
  ...
  useEffect(() => {
    ...
    if (step.type === "element" && step.id) {
      ...
      // Posición de flecha dependiendo del espacio
