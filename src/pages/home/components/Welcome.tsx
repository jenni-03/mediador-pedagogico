        ...
        <div className="space-y-8 max-w-2xl mx-auto text-left">
          <div>
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white leading-tight">
              Bienvenidos al{" "}
              <span className="text-red-500">Mediador Pedagógico </span>
              sobre
            </h1>
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white leading-tight">
              <span className="text-red-500">Estructuras de Datos</span>
            </h1>
          </div>

          <p className="text-lg text-gray-300">
            Aprende Estructuras de Datos en Java de forma interactiva.
          </p>

          <p className="text-lg text-gray-300 mt-8">
            A continuación, encontrarás enlaces al código fuente en el cuál se
            basaron las estructuras de datos, y a recursos de aprendizaje
            adicionales.
          </p>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              Learning
              <FaGraduationCap size={20} className="text-red-400" />
            </motion.a>
          </div>
        </div>
