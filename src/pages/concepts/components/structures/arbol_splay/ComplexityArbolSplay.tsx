import { complexityArbolSplay } from "../../../../../shared/constants/complexityStructures/complexityArbolSplay";
import { CodeAnalysis } from "../../molecules/CodeAnalysis";

export function ComplexityArbolSplay() {
  return (
    <div className="py-4 px-10">
      <h1 className="text-2xl font-extrabold text-white mb-1">
        COSTO OPERACIONAL Y COMPLEJIDAD
      </h1>
      <h1 className="text-sm text-red-400 mb-3">Árbol Splay</h1>
      <hr className="mt-2 mb-4 border-red-500 border-t-2" />
      <SplayAlgorithmAnalysis />
      <div>
        <div className="space-y-8">
          {complexityArbolSplay.map((method, index) => (
...
function SplayAlgorithmAnalysis() {
  return (
    <section className="mb-10">
      <div className="bg-[#18181b] border-l-4 border-[#ef4444] rounded-xl p-6 shadow-lg">
        ...
        <h3 className="text-lg font-semibold text-[#f87171] mb-4">
          Costo Operacional y Complejidad (ArbolSplay)
        </h3>
        <p className="text-gray-200 text-[15px] mb-3">
          Los análisis que se presentan a continuación son para el{" "}
