...
export function OperationCola() {
    return (
        <div className="py-4 px-10">
            <h1 className="text-3xl font-extrabold mb-1 text-white">OPERACIONES</h1>
            <h1 className="text-sm text-red-400 mb-3">Secuencia</h1>
            <hr className="mt-2 mb-4 border-red-500 border-t-2" />
            <div className="text-sm text-gray-300 leading-6">
                <h1 className="text-2xl font-bold text-red-500 mb-3">Encolar (Enqueue)</h1>
                <p className="mb-5">
                ...
                <img src={img1} alt="img 1" className="mx-auto w-40 sm:w-96 md:w-96 lg:w-[40rem]"/>
            ...
            <div className="text-sm text-gray-300 leading-6">
                <h1 className="text-2xl font-bold text-red-500 my-4">Decolar (Dequeue)</h1>
                <p className="mb-5">
