import { complexityData } from "../../../../../shared/constants/complexityData";
        ...
        <div className="py-4 px-10">
            ...
            <div>
                ...
                <div className="space-y-6">
                    {complexityData.map((method, index) => (
                        <div key={index} className="border-b pb-4">
                            <h2 className="text-xl font-semibold mb-2">
                                {method.title}
                            </h2>
                            <div>
                                <CodeAnalysis code={method.javaCode} operationalCost={method.operationalCost} complexity={method.complexity} />
                            </div>
                        </div>
                    ))}
                </div>
