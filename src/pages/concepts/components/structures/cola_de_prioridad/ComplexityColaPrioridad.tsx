import { complexityColaPrioridad } from "../../../../../domain/constants/complexityStructures/complexityColaPrioridad";
    ...
    <div className="py-6 px-3 sm:px-10 max-w-4xl mx-auto text-white">
      ...
      <div className="mt-6 bg-[#18191a] p-4 rounded-md border-l-4 border-red-500">
        ...
        <p className="text-gray-200 text-sm leading-6">
          El análisis muestra que la estructura <b>Cola Prioridad</b> se basa en
          la cola simple, pero debe recorrer múltiples veces su tamaño y además
          ordenar por prioridad. Esto puede llevar a una complejidad cuadrática{" "}
          <b>O(n²)</b> en el peor de los casos, especialmente al insertar o
