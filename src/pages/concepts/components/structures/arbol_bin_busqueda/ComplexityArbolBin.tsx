import { complexityArbolBinarioBusqueda } from "../../../../../shared/constants/complexityStructures/complexityArbolBinarioBusqueda";
import { CodeAnalysis } from "../../molecules/CodeAnalysis";

export function ComplexityArbolBinarioBusqueda() {
  return (
    <div className="py-4 px-10">
      <h1 className="text-2xl font-extrabold text-white mb-1">
        COSTO OPERACIONAL Y COMPLEJIDAD
      </h1>
      <h1 className="text-sm text-red-400 mb-3">Árbol Binario de Búsqueda</h1>
      <hr className="mt-2 mb-4 border-red-500 border-t-2" />
      <BinarySearchAlgorithmAnalysis />
      <div>
        <div className="space-y-8">
          {complexityArbolBinarioBusqueda.map((method, index) => (
...
function BinarySearchAlgorithmAnalysis() {
  return (
    <section className="mb-10">
      <div className="bg-[#18181b] border-l-4 border-[#ef4444] rounded-xl p-6 shadow-lg">
        ...
        <h3 className="text-lg font-semibold text-[#f87171] mb-4">
          Costo Operacional y Complejidad (ArbolBinarioBusqueda)
        </h3>
        <p className="text-gray-200 text-[15px] mb-3">
          Los siguientes análisis se realizan para el{" "}
          <span className="font-bold">peor de los casos (Big O)</span>,
          utilizando el{" "}
          <span className="text-[#ef4444] font-bold">Teorema Maestro</span> y la
          notación estándar para algoritmos recursivos:
        </p>
        {/* Teorema Maestro */}
