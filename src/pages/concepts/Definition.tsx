...
import {
  ...
  DefinitionArbolB,
  DefinitionArbol123,
  DefinitionArbolEneario,
  DefinitionArbolHeap,
  DefinitionArbolSplay,
  DefinitionArbolRojiNegro,
  DefinitionArbolBinarioBusqueda,
  DefinitionArbolAVL,
  DefinitionArbolBinario,
  DefinitionCola,
  DefinitionColaPrioridad,
  DefinitionListaCDoble,
  DefinitionListaCSimple,
  DefinitionListaDoble,
  DefinitionListaSimple,
  DefinitionPila,
  DefinitionSecuencia,
  DefinitionTablaHash,
} from "./concepts";
...
const componentMap: Record<string, React.FC> = {
  ...
  "Árbol Heap": DefinitionArbolHeap,
  "Árbol Eneario": DefinitionArbolEneario,
  "Árbol 1-2-3": DefinitionArbol123,
  "Árbol B": DefinitionArbolB,
  "Árbol B+": DefinitionArbolB2,
};
