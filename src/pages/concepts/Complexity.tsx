...
const componentMap: Record<string, React.FC> = {
  ...
  "Árbol Heap": ComplexityArbolHeap,
  "Árbol Eneario": ComplexityArbolEneario,
  "Árbol 1-2-3": ComplexityArbol123,
  "Árbol B": ComplexityArbolB,
  "Árbol B+": ComplexityArbolB2,
};
