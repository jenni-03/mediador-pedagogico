 ...
 */`,
    ...
    labels: {
      ...
      SET_Y_LEFT: 56,
      IF_INNER_LR: 57,
      APPLY_LR_LEFT_ROT: 58,
      APPLY_LR_RIGHT_ROT: 59,
      ELSE_LL: 61,
      APPLY_LL_ROT: 62,
      ELSE_IF_BF_NEG_TWO: 65,
      SET_Y_RIGHT: 66,
      IF_INNER_RL: 67,
      APPLY_RL_RIGHT_ROT: 68,
      APPLY_RL_LEFT_ROT: 69,
      ELSE_RR: 71,
      APPLY_RR_ROT: 72,
      RETURN_REBALANCED: 75,

      // Método rotacionDerecha(NodoAVL<T> y)
      ROT_RIGHT_DECL_X: 81,
      ROT_RIGHT_DECL_T2: 82,
      SET_X_RIGHT_LINK: 84,
      SET_Y_LEFT_LINK: 85,
      ROT_RIGHT_RECALC_Y: 87,
      ROT_RIGHT_RECALC_X: 88,
      ROT_RIGHT_RETURN: 90,
      ...
      ROT_LEFT_DECL_T2: 97,
      SET_Y_LEFT_LINK2: 99,
      SET_X_RIGHT_LINK2: 100,
      ROT_LEFT_RECALC_X: 102,
      ROT_LEFT_RECALC_Y: 103,
      ROT_LEFT_RETURN: 105,

      // Método recalcularAltura(NodoAVL<T> r)
      GET_LEFT_HEIGHT: 111,
      GET_RIGHT_HEIGHT: 112,
      SET_HEIGHT: 113,

      // Método getBalance(NodoAVL<T> r)
      IF_NODE_NULL_BALANCE: 119,
      RETURN_ZERO_BALANCE: 120,
      GET_LEFT_HEIGHT2: 122,
      GET_RIGHT_HEIGHT2: 123,
      RETURN_BF: 124
    },
    errorPlans: {
      DELETE_EMPTY: [
